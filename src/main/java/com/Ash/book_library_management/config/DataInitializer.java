...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        bookRepository.saveAll(Arrays.asList(
                new Book("Harry Potter and the Sorcerer's Stone", author1, "Fantasy", 1997),
                new Book("Harry Potter and the Chamber of Secrets", author1, "Fantasy", 1998),
                new Book("Harry Potter and the Prisoner of Azkaban", author1, "Fantasy", 1999),

                new Book("A Game of Thrones", author2, "Fantasy", 1996),
                new Book("A Clash of Kings", author2, "Fantasy", 1998),
                new Book("A Storm of Swords", author2, "Fantasy", 2000),
                new Book("A Feast for Crows", author2, "Fantasy", 2005),

                new Book("Clean Code", author3, "Programming", 2008),
                new Book("Clean Architecture", author3, "Programming", 2017),
                new Book("The Pragmatic Programmer", author3, "Programming", 1999),

                new Book("Murder on the Orient Express", author4, "Mystery", 1934),
                new Book("Death on the Nile", author4, "Mystery", 1937),
                new Book("And Then There Were None", author4, "Mystery", 1939),

                new Book("The Shining", author5, "Horror", 1977),
                new Book("It", author5, "Horror", 1986),
                new Book("Misery", author5, "Horror", 1987),

                new Book("Foundation", author6, "Sci-Fi", 1951),
                new Book("I, Robot", author6, "Sci-Fi", 1950),
                new Book("The Caves of Steel", author6, "Sci-Fi", 1953)
        ));
